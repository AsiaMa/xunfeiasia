 ...
 * 
 */
package iflytek.ise.result.xml;
...
import iflytek.ise.result.FinalResult;
import iflytek.ise.result.ReadSentenceResult;
import iflytek.ise.result.ReadSyllableResult;
import iflytek.ise.result.ReadWordResult;
import iflytek.ise.result.Result;
import iflytek.ise.result.entity.Phone;
import iflytek.ise.result.entity.Sentence;
import iflytek.ise.result.entity.Syll;
import iflytek.ise.result.entity.Word;
